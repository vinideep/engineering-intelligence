...
1. **Read Intelligence** — Consult `$EIknowledge-base/`, `$EImemory/`, `$EIcontext/`, `$EIgraph/`
...
10. **Record Change** — Write `$EIchanges/CHG-XXX-<summary>.md` referencing related reports and acceptance verification
