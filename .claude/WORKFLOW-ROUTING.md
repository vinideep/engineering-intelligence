...
|---|---|---|
| `engineering-intelligence` | `engineering-intelligence-skill`, `aidlc-lifecycle-engine`, `impact-analysis-engine`, `context-budget-optimizer` | `change-detection-engine`, `incremental-sync-engine`, `change-history-engine`, `environmental-backpressure-engine`, `testing-intelligence-engine` |
...
| `decompose-backlog` | `backlog-decomposition-engine`, `context-budget-optimizer` | `issue-tracker-sync-engine`, `aidlc-lifecycle-engine` |
...
| `scope-requirement` | `requirement-scoper` | `context-budget-optimizer`, `aidlc-lifecycle-engine` |
